  ...
  <div class="ref-container">
    <div>
     ...
     <div class="paper-image">
        ...
        <img src="images/UZ_50.png" alt="Fermat triples" class="responsive-img">
        </a>
    </div>
...
(<a href="https://arxiv.org/abs/2508.13059" class="arxiv">2508.13059</a>)
    ...
    <div class="paper-image">
        ...
        <img src="images/belyi-fiber.png" alt="belti-stack" class="responsive-img">
        </a>
    </div>
       <div>
...
(<a href="http://arxiv.org/abs/2505.09589" class="arxiv">2505.09589</a>, <a href="https://github.com/SamFrengley/exceptional-tate-classes" class="code">code</a>)
    ...
    <div class="paper-image">
        ...
        <img src="images/np.png" alt="Newton polygon" class="responsive-img">
        </a>
    </div>
...
(<a href="http://arxiv.org/abs/2504.07750" class="arxiv">2504.07750</a>, <a href="https://github.com/sarangop1728/counting-5-isogenies"
    ...
    <div class="paper-image">
        ...
        <img src="images/bowtie.jpeg" alt="Bowtie image" class="responsive-img">
        </a>
    </div>
...
function fields</b>, </br> with  Mar&iacute;a Chara, Asimina S. Hamakiotes,
    ...
    <div class="paper-image">
        ...
        <img src="images/oaxaca.png" alt="Positive graph" class="responsive-img">
        </a>
    </div>
    ...
    <div>
     ...
     <div class="paper-image">
        ...
        <img src="images/W6.png" alt="W6 mobile" class="responsive-img">
        </a>
    </div>
    ...
    <div class="paper-image">
        ...
        <img src="images/3.4.ab_ad_m.gif" alt="Batman gif" class="responsive-img">
        </a>
    </div>
  ...
  <div>
    <li> <b>Mertens' theorem for Chebotarev sets</b>, </br>with Daniel Keliher and
     ...
     <div class="paper-image">
        ...
        <img src="images/mertens.png" alt="Table summary" class="responsive-img">
        </a>
    </div>
  ...
  <div class="paper-image">
      <a href="images/euler.png">
          <img src="images/euler.png" alt="Graph euler function" class="responsive-img">
      </a>
  </div>
</div>
</ol>
