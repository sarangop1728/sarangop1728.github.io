...
* Coordinates
** Instructor
[[https://sarangop1728.github.io/][Santiago Arango-Piñeros]], Ph.D. (He/His).
...
proofs and development of precise mathematical reasoning and writing.
...
+ ~PSET5~: Direct and semidirect producs
+ ~PSET6~: Finitely generated abelian groups
+ ~PSET7~: Group actions and the Sylow theorems

** Midterm exams (~800 points~)
There will be four midterm exams, each one worth ~200 points~. Each exam will
...
*Questions 3* will consist of five /True/ or /False/ questions, no
...
+ ~EXAM1~: Based on lectures 1-5 and ~PSETs~ 0, 1, 2. <2026-02-25 Wed>
+ ~EXAM2~: Based on lectures 6-10 and ~PSETs~ 0, 3, 4. <2026-03-25 Wed>
+ ~EXAM3~: Based on lectures 11-15 and ~PSETs~ 0, 5, 6. <2026-04-15 Wed>
+ ~EXAM4~: Based on lectures 16-20 and ~PSETs~ 0, 7. <2026-05-06 Wed>

See the [[*Mistakes were made policy][``Mistakes were made'' policy]] below.


** Final exam (~200 points~)
The ~FINAL EXAM~ will be held at LGRT-??? on ??? at ???. This exam evaluates
the contents of all lectures and all ~PSETs~. It will consist of four
...
Corrections are due exactly one week after the exam date and must be submitted
through *Gradescope* before midnight.

The correction for each problem must include the following.

1. A complete explanation of your mistake.
2. A complete explanation of a correct solution.
...
| <2026-05-06 Wed> | *Exam 4* (Problems day)               |                  |
|------------------+---------------------------------------+------------------|
